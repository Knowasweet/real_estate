...
class ProfileFactory(factory.django.DjangoModelFactory):
    ...
    count_reviews = factory.LazyAttribute(lambda x: faker.random_int(min=0, max=25))
...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    second_name = factory.LazyAttribute(lambda x: faker.last_name())
    username = factory.LazyAttribute(lambda x: faker.first_name())
    email = factory.LazyAttribute(lambda x: 'estate@estate.com')
